...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    partnership: {
      ...
      subtitle: 'Join forces to create lasting impact and transform communities together',
    ...
    volunteer: {
      ...
      makeImpactDesc: 'Directly contribute to meaningful projects that change lives',
  ...
  id: {
    ...
    blog: {
      ...
      joinSubscribers: 'Bergabung dengan 5.000+ pelanggan. Berhenti berlangganan kapan saja.',
    ...
    volunteer: {
      ...
      makeImpactDesc: 'Berkontribusi langsung pada proyek bermakna yang mengubah hidup',
      learnGrow: 'Belajar & Berkembang',
      learnGrowDesc: 'Kembangkan keterampilan baru dan dapatkan pengalaman berharga',
      connect: 'Terhubung',
      connectDesc:
    ...
    cta: {
      ...
      flexibleScheduleDesc: 'Online atau di tempat, penuh waktu atau paruh waktu',
