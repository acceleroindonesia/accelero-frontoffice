        ...
        <div className="container">
          <div className="blog-hero-content">
            ...
            <p className="page-subtitle">
              Discover the latest news, impact stories, and updates from our
        ...
        <div className="container">
          <div className="newsletter-card">
            <div className="newsletter-content">
              <h2>Stay Updated</h2>
              <p>
                Subscribe to our newsletter to receive the latest impact
                stories, program updates, and volunteer opportunities directly
                in your inbox.
              </p>
            </div>
