      ...
      <div className='container'>
        <div className='padding-bottom center'>
          ...
          <p className='gray form-information'>
            Whether you&apos;re selling one ticket or a hundred thousand, the accelero ticketing
      ...
      <div className='container'>
        <div className='center'>
          ...
          <p className='gray form-information'>
            ...
            online with accelero ticketing, you&apos;ll first create a beautiful event website to
            promote your event.
          </p>
          <div className='button-container'>
            <ButtonLink
    ...
    <Section>
      <div className='container'>
        <div className='center'>
          ...
          <p className='gray'>100% accelero ticketing backed guarantee.</p>
        </div>
      </div>
...
const canonical = 'https://accelero-ticketing.com/promoters';
