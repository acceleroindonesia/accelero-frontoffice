...
const Form: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<any> => {
    ...
    if (res?.ok) {
      showAlert({ type: 'success', text: 'Success auth redirect to user page...' });
      window.location.href = '/members/account'; // or router.push
    } else {
      ...
      <div className='form-elements'>
        ...
        <div className='form-line'>
          <div className='label-line flex flex-v-center flex-space-between'>
            ...
            <Link href='/members/forgot' className='red'>
              Forgot password?
            </Link>
          </div>
          <Input
        ...
        <div className='form-buttons'>
          <Button type='submit' color='red-filled' text='Sign in' />
        </div>
      </div>
    </form>
  );
