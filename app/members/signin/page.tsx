  ...
  <div className="auth-page">
    ...
    <div className="auth-container">
      <div className="auth-header">
        <h1>Welcome Back</h1>
        <p>
          Sign in to your account to continue your journey with Accelero
          Foundation.
        </p>
      </div>
      ...
      <div className="auth-footer">
        <p>
          ...
          <Link href="/members/signup">Create one here</Link>
        </p>
      </div>
    </div>
...
export const metadata: Metadata = {
  ...
  description,
  keywords:
    "sign in, login, accelero foundation, education, volunteer, donate",
