  ...
  <div className="auth-page">
    ...
    <div className="auth-container">
      <div className="auth-header">
        ...
        <p>Join Accelero Foundation and start making a difference in education.</p>
      </div>
      ...
      <div className="auth-footer">
        <p>
          Already have an account? <Link href="/members/signin">Sign in here</Link>
        </p>
      </div>
    </div>
...
export const metadata: Metadata = {
  title,
  description,
  keywords: 'sign up, register, accelero foundation, education, volunteer, donate',
